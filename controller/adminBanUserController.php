<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $action = isset($_POST['action']) ? $_POST['action'] : ''; // 'ban' or 'restrict'
        ...
        elseif($action === 'remove_restriction'){
            // Remove restriction (also clear permanent bans for this user)
            ...
            if($stmt){
                ...
                if($stmt->execute()){
                    // Update user status back to active in user table
